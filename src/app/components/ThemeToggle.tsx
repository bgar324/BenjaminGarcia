  ...
  return (
    ...
    >
      <button
        ...
        className="group relative w-fit border border-gray-300 rounded-md pl-1 pr-2 py-1 text-xs uppercase mt-10 mb-5 lg:mt-0 lg:mb-5 font-semibold flex flex-row items-center gap-0.5 hover:cursor-pointer
        transition-colors duration-300 ease-[var(--theme-transition-ease)]"
      >
