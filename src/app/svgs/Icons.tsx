export const LocationIcon = () => (
  ...
  >
    <path
      ...
      fill="var(--icon-muted)"
    />
    <circle cx="12" cy="10" r="2" fill="var(--icon-contrast)" />
  </svg>
)
...
export const LinkedInIcon = () => (
  ...
  >
    ...
    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
    <g id="SVGRepo_iconCarrier">
      <path d="M6.5 8C7.32843 8 8 7.32843 8 6.5C8 5.67157 7.32843 5 6.5 5C5.67157 5 5 5.67157 5 6.5C5 7.32843 5.67157 8 6.5 8Z" fill="var(--icon)" />
      <path d="M5 10C5 9.44772 5.44772 9 6 9H7C7.55228 9 8 9.44771 8 10V18C8 18.5523 7.55228 19 7 19H6C5.44772 19 5 18.5523 5 18V10Z" fill="var(--icon)" />
      <path d="M11 19H12C12.5523 19 13 18.5523 13 18V13.5C13 12 16 11 16 13V18.0004C16 18.5527 16.4477 19 17 19H18C18.5523 19 19 18.5523 19 18V12C19 10 17.5 9 15.5 9C13.5 9 13 10.5 13 10.5V10C13 9.44771 12.5523 9 12 9H11C10.4477 9 10 9.44772 10 10V18C10 18.5523 10.4477 19 11 19Z" fill="var(--icon)" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -7559.000000)" fill="var(--icon)">
...
export const SpotifyIcon = () => (
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <defs></defs>
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -7479.000000)" fill="var(--icon-contrast)">
          <g id="icons" transform="translate(56.000000, 160.000000)">
            <path
...
export const Hamburger = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M3 5H21" stroke="var(--icon)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
    <path d="M3 12H21" stroke="var(--icon)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
    <path d="M3 19H21" stroke="var(--icon)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
  </svg>
)
